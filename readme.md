[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ipr0310_my-nice-app&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=ipr0310_my-nice-app)
### My To-do app stack:
| Stack                      | Version     |
|----------------------------|-------------|
| React Native               | 70.5        |
